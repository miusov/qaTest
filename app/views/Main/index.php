    ...
    <div class="row filter">
        <form action="/main" method="post">
            ...
            <div class="col-md-2">
                ...
                <input type="text" name="mileage2" id="mileage2">
            </div>
            <div class="col-md-2">
                ...
                <input type="text" name="masters" id="masters">
            </div>
            <div class="col-md-12">
                <br>
...
<?php foreach ($ads as $k => $v){ ?>
    ...
    <p class="text-right" style="color: gray; font-style: italic">Дата публикации: <?php echo $v['created_at'] ?></p>
    <hr>
<?php } ?>
</div>
